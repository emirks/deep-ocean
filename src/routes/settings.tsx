      ...
      <DialogContent>
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="rounded-md border border-purple-500/20 bg-purple-500/5 px-4 py-3 select-none">
            <p className="text-sm font-medium text-purple-200 whitespace-pre-wrap break-words" style={{ userSelect: 'none' }}>{phrase}</p>
          </div>
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              className={`w-full resize-none rounded-md border bg-background px-3 py-2 text-sm shadow-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring whitespace-pre-wrap break-words ${error ? 'border-red-500' : 'border-input'}`}
            />
